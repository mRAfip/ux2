      ...
      <div className="flex px-6 flex-col w-full max-w-7xl mx-auto z-10">
        ...
        `}</style>
          ...
          <p className="text-lg md:text-2xl text-gray-700 max-w-2xl mb-8">
            ...
            <Image src="/icons/figma.png" alt="Figma" width={20} height={20} className="inline-block mb-1" /><br />
            — and build websites & dashboards using{' '}
            <strong>Next.js</strong>{' '}
            <Image src="/icons/next.png" alt="Next.js" width={20} height={20} className="inline-block mb-1" /> and{' '}
            <strong>Tailwind CSS</strong>{' '}
            <Image src="/icons/tailwind.svg" alt="Tailwind CSS" width={20} height={20} className="inline-block mb-1" />.
          </p>
