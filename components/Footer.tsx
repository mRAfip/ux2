...
import { Linkedin, Instagram, UserPlus, Youtube, Twitter } from 'lucide-react';

export default function Footer() {
  return (
    <footer className="bg-[#66141A] text-white px-6 md:px-12 pt-16 pb-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 border-b border-white/20 pb-10">
          ...
          <div>
            ...
            <a
              ...
              className="text-3xl md:text-4xl lg:text-5xl font-semibold underline underline-offset-4 hover:text-red-400 transition break-all"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mt-10 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link href="#">UI/UX Articles</Link></li>
              <li><Link href="#">Free Templates</Link></li>
              <li><Link href="#">Frontend Snippets</Link></li>
